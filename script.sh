...
mkdir tempdata
cp -u /localdisk/data/BPSM/ICA1/fastq/* ./tempdata
...
awk 'BEGIN{FS="\t";}{if($7 != "End2"){print $7}}' ./tempdata/Tco2.fqfiles | cut -d "." -f 1 > ./temp/fastqlist_end2.txt
...
while read line
do
fastqc -o ./fastqcreport --extract ./tempdata/${line}.fq.gz
...
paste ./temp/report1.txt ./temp/end1_fail.txt > ./temp/report2.txt
paste ./temp/report2.txt ./temp/end1_warn.txt > ./temp/report3.txt
paste ./temp/report3.txt ./temp/end2_pass.txt > ./temp/report4.txt
paste ./temp/report4.txt ./temp/end2_fail.txt > ./temp/report5.txt
paste ./temp/report5.txt ./temp/end2_warn.txt > ./temp/report6.txt
